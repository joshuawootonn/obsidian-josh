...
export const WEEKLY_PLAN_TEMPLATE_PATH = "Templates/Weekly Plan.md";
export const MONTHLY_REVIEW_FOLDER = "Log";
export const MONTHLY_REVIEW_TEMPLATE_PATH = "Templates/Monthly Review.md";
